...
def build_slot_prompts_adversarial_untargeted(history, agent_name,voting_moderator_name,window_size=6,final_round=False): 
    personalized_history,last_plan = format_history(agent_name, history,voting_moderator_name) 
    slot_prompt = "The following is a chronological history of up to "+str(window_size)+ " interactions <HISTORY> " + personalized_history + " </HISTORY> "      
...
def build_slot_prompts_adversarial_targeted(history, agent_name,voting_moderator_name,target_name='Local Labour Union',window_size=6,final_round=False): 
    personalized_history,last_plan = format_history(agent_name, history,voting_moderator_name) 
    slot_prompt = "The following is a chronological history of up to "+str(window_size)+ " interactions <HISTORY> " + personalized_history + " </HISTORY> "      
